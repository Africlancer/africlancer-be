...
import { PageParams, PageResult, Portfolio, PortfolioDocument, handlePageFacet, handlePageResult } from './portfolio.schema';
...
export class PortfolioRepository {
  ...
  public async page(query: Partial<Portfolio>, page: PageParams): Promise<PageResult<Portfolio>> {
